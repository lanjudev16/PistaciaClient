...
const Exclusive = () => {
  return (
    <div className="grid lg:grid-cols-[3fr,5fr] grid-cols-1 lg:my-14 gap-5 border-2 border-[#FCA5A4] rounded-md p-5 lg:p-20 flex-row-reverse overflow-hidde lg:mx-0 mx-5">
      <div>
